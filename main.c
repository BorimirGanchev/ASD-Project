...
int main(int argc, char* args[]) {
    ...
    int path[] = {0, 1, 2, 3, 4, 6, 8, 9, 7, 5, 45, 44, 38, 35, 19, 15, 36, 37, 9 ,11, 13, 14, 12, 10, 12, 14, 16, 17, 18, 20, 22, 25, 23, 20, 19, 21, 34, 33, 24, 29, 26, 27, 28, 29, 30, 31, 41, 42, 42, 43, 39, 32, 42, 43, 39, 40, 42, 43, 47, 46, 43, 47, 46 };
